...
namespace ServicePlusAPIs.Migrations.ServicePlus
{
    ...
    [Migration("20250516093302_AddImportCertificateDetailFromExcelstableChangeSequence")]
    partial class AddImportCertificateDetailFromExcelstableChangeSequence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServicePlusAPIs.Models.SportsModel.ImportCertificateDetailFromExcel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ImportCertificateDetailFromExcels");
                });
            ...
            modelBuilder.Entity("ServicePlusAPIs.UserModels.RegisterUserDepartment", b =>
                {
                    ...
                    b.ToTable("RegisterUserDepartments");
                });

            modelBuilder.Entity("ServicePlusAPIs.UserModels.RegisterUserDistrict", b =>
                {
                    ...
                    b.ToTable("RegisterUserDistricts");
                });

            modelBuilder.Entity("ServicePlusAPIs.UserModels.RegisterUserService", b =>
                {
                    b.Property<int>("ServiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("RegisterUserServices");
                });
            ...
            modelBuilder.Entity("ServicePlusAPIs.UserModels.RegisterUserDepartment", b =>
                {
                    b.HasOne("ServicePlusAPIs.UserModels.RegisterUser", "User")
                        .WithMany("RegisterUserDepartments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ServicePlusAPIs.UserModels.RegisterUserDistrict", b =>
                {
                    b.HasOne("ServicePlusAPIs.UserModels.RegisterUser", "User")
                        .WithMany("RegisterUserDistricts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ServicePlusAPIs.UserModels.RegisterUser", b =>
                {
                    b.Navigation("RegisterUserDepartments");

                    b.Navigation("RegisterUserDistricts");

                    b.Navigation("RegisterUserServices");
                });
