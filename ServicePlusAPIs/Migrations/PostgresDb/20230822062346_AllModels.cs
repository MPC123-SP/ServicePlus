    ...
    public partial class AllModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CustomLGDDistricts",
                columns: table => new
                {
                    CustomLGDDistrictId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CustomLGDDDistrictCode = table.Column<string>(type: "text", nullable: true),
                    CustomLGDDDistrictName = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomLGDDistricts", x => x.CustomLGDDistrictId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PendencyReportId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DistrictName = table.Column<string>(type: "text", nullable: true),
                    ApplicationRecieved = table.Column<int>(type: "integer", nullable: true),
                    Deliverd = table.Column<int>(type: "integer", nullable: true),
                    Rejected = table.Column<int>(type: "integer", nullable: true),
                    InProcess = table.Column<int>(type: "integer", nullable: true),
                    Day1to5 = table.Column<int>(type: "integer", nullable: true),
                    Day6to30 = table.Column<int>(type: "integer", nullable: true),
                    Day31to60 = table.Column<int>(type: "integer", nullable: true),
                    Day61to90 = table.Column<int>(type: "integer", nullable: true),
                    Day91toAbove = table.Column<int>(type: "integer", nullable: true),
                    TotalPendingDays = table.Column<int>(type: "integer", nullable: true),
                    SendBack = table.Column<int>(type: "integer", nullable: true),
                    PendencyPercentage = table.Column<double>(type: "double precision", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PendencyReport", x => x.PendencyReportId);
                });

            migrationBuilder.CreateTable(
                name: "CustomLGDTehsilSubTehsils",
                columns: table => new
                {
                    CustomLGDTehsilSubTehsilId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CustomLGDDistrictId = table.Column<int>(type: "integer", nullable: false),
                    CustomLGDTehsilSubTehsilCode = table.Column<string>(type: "text", nullable: true),
                    CustomLGDTehsilSubTehsilName = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomLGDTehsilSubTehsils", x => x.CustomLGDTehsilSubTehsilId);
                    table.ForeignKey(
                        name: "FK_CustomLGDTehsilSubTehsils_CustomLGDDistricts_CustomLGDDistr~",
                        column: x => x.CustomLGDDistrictId,
                        principalTable: "CustomLGDDistricts",
                        principalColumn: "CustomLGDDistrictId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomLGDTehsilSubTehsils_CustomLGDDistrictId",
                table: "CustomLGDTehsilSubTehsils",
                column: "CustomLGDDistrictId");
