...
namespace ServicePlusAPIs.ViewModels.CommonModel.ExecutionCommonModel
{
    public class TaskDetailViewModelZombie
    {
        ...
        public UserDetailViewModelZombie? user_detail
        {
            get;
            set;
        }
    ...
    public class UserDetailViewModelZombie
    {
